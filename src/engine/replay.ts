...
export const PRESETS: ReplayPreset[] = [
  {
    ...
    frames: [
      ...
      { t: 8, mcap: 7200, ...healthy, dev_balance: 420_000_000, label: "first dev sell" },
      ...
      { t: 150, mcap: 12600, ...healthy, dev_balance: 420_000_000, label: "rent print" },
      { t: 165, mcap: 14000, ...healthy, dev_balance: 420_000_000, label: "local high" },
      { t: 180, mcap: 7000, unique_buyers: 44, unique_buyers_prev: 48, buy_sol: 5, sell_sol: 6, dev_balance: 420_000_000, label: "−50% wick" },
      { t: 255, mcap: 8000, ...healthy, dev_balance: 420_000_000, label: "reclaim" },
      { t: 280, mcap: 18000, ...healthy, dev_balance: 420_000_000, label: "3×" },
      { t: 310, mcap: 30000, ...healthy, dev_balance: 420_000_000, label: "5×" },
  ...
  },
  {
    ...
    frames: [
      ...
      { t: 165, mcap: 12400, unique_buyers: 36, unique_buyers_prev: 48, buy_sol: 2, sell_sol: 7, label: "sell print" },
  ...
  },
  {
    ...
    frames: [
      ...
      { t: 15, mcap: 6400, ...healthy, label: "ignore end" },
      { t: 135, mcap: 5200, ...healthy, label: "shakeout end" },
      { t: 150, mcap: 12600, unique_buyers: 40, unique_buyers_prev: 32, buy_sol: 9, sell_sol: 2, dev_balance: 1_000_000_000, label: "2.1× peel" },
      { t: 160, mcap: 14000, unique_buyers: 52, unique_buyers_prev: 40, buy_sol: 11, sell_sol: 2, dev_balance: 1_000_000_000, label: "2.5× hold" },
      { t: 168, mcap: 15400, unique_buyers: 58, unique_buyers_prev: 52, buy_sol: 12, sell_sol: 2, dev_balance: 1_000_000_000, label: "2.75× hold" },
      { t: 176, mcap: 16800, unique_buyers: 64, unique_buyers_prev: 58, buy_sol: 13, sell_sol: 2, dev_balance: 1_000_000_000, label: "3× cap" },
    ],
  },
  {
    id: "Cheshire_70_dump",
