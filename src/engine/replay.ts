...
export const PRESETS: ReplayPreset[] = [
  ...
  },
  {
    ...
    blurb: "6k fill, chops below 1.15× forever, sits until 600s DEAD_NO_RENT",
    ...
    frames: [
      ...
      { t: 15, mcap: 6300, ...healthy, label: "open ignore end" },
      { t: 80, mcap: 6200, ...healthy, label: "chop — never spikes" },
      { t: 135, mcap: 5400, unique_buyers: 22, unique_buyers_prev: 30, buy_sol: 2, sell_sol: 3, label: "seek rent" },
      { t: 300, mcap: 5200, unique_buyers: 18, unique_buyers_prev: 22, buy_sol: 1, sell_sol: 2, label: "chop" },
      { t: 600, mcap: 5200, unique_buyers: 12, unique_buyers_prev: 18, buy_sol: 0.4, sell_sol: 1.2, label: "timeout" },
    ],
  },
  {
    id: "Shakeout_death",
